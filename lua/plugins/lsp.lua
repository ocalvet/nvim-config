return {
	...
	dependencies = {
		...
		{ "mason-org/mason.nvim", commit = "4da89f3", config = true }, -- NOTE: Must be loaded before dependants
		-- mason-lspconfig:
		...
		{ 
			...
			opts = function()
				local servers = {
					"ts_ls", "ruff", "pylsp", "html", "cssls", "tailwindcss", 
	...
	config = function()
		...
		-- mason-lspconfig handles server installation via opts.ensure_installed above
