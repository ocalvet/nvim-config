return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>gD", "<cmd>DiffviewOpen HEAD~1<CR>", opts)
        ...
        -- Focus/toggle files
        vim.keymap.set("n", "<leader>gf", "<cmd>DiffviewFocusFiles<CR>", opts)
        vim.keymap.set("n", "<leader>gt", "<cmd>DiffviewToggleFiles<CR>", opts)
    end,
}